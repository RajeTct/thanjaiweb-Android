...
import { GeocoderResponse } from '../_helper/geocoder-response.model';
...
export class GeocodingService {
  ...
  getLocation(term: string): Observable<GeocoderResponse> {
    const url = `https://maps.google.com/maps/api/geocode/json?address=${term}&sensor=false&key=${'AIzaSyAsUhYQ_SwYsajCUp15L7MBK7CK0C4-B3w'}`;
