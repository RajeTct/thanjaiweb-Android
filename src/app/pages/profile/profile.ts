...
export class ProfilePage extends BasePage implements OnInit {
  ...
  //To navigate Events page
  goToEvents() {
    this.router.navigateByUrl('/1/home/all-events');
  }

  //To navigate BloodRequired page
  goToBloodRequired() {
    this.router.navigateByUrl('/1/home/all-blood-required');
  }

  //To navigate Lost/Found page
  goToLostFound() {
    this.router.navigateByUrl('/1/home/all-lost-found');
  }
}
