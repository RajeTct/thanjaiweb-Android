...
@Component({
  selector: 'app-all-company-details',
  templateUrl: './all-company-details.component.html',
  styleUrls: ['./all-company-details.component.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class AllCompanyDetailsComponent extends BasePage {
  ...
  //GetPaidPromotionClientByCategoryId
  ...
  //Used to get company default color for PAID CLIENTS
  getPaidClientsColor(product: any): string {
    const index = this.paidClients.indexOf(product);
    const colorIndex = index % this.colors.length;
    return this.colors[colorIndex];
  }

  //Used to get company default color for NOT PAID CLIENTS
  getNotPaidClientsColor(product: any): string {
  ...
  //Used to navigate detail page
  goToDetailPage(client) {
    this.router.navigateByUrl('/1/home/places/' + client.clientCustomUrl);
    console.log('/1/home/places/' + client.clientCustomUrl);
  }
